...
import static com.libii.sso.common.model.ProjectConstant.MAPPER_INTERFACE_REFERENCE;
...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://192.168.0.26:3306/unity_up?useUnicode=true&characterEncoding=utf8&useSSL=false";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "xuejinyu";
     ...
     * 项目基础包名称
     */
    private static final String BASE_PACKAGE_PATH = "/com/libii/sso";
    private static final String BASE_PACKAGE_ABSOLUTE_PATH = PROJECT_PATH + JAVA_PATH + "/com/libii/sso";
    // controller 的路径 不一样
    private static final String CONTROLLER_PATH = PROJECT_PATH + "/web/src/main/java/com/libii/sso";

    public static final String BASE_PACKAGE = "com.libii.sso";
    ...
    private static final String AUTHOR = "Generate"; // TODO 此处可替换作者
...
//        genCodeByCustomModelNameAndTemplate("user", "user", "User","simpleDict"); // 调用simpleDict的模板
        genCodeByCustomModelNameAndTemplate("project", "unity", "Project","simpleDict"); // 调用simpleDict的模板
