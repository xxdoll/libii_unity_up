...
public class ${modelNameUpperCamel}Controller {
    ...
    public RestResult add(@ApiParam(name = "XX信息", required = true) @RequestBody ${modelNameUpperCamel} ${modelNameLowerCamel}) { // TODO 5. API方法参数的说明
    ...
    public RestResult<${modelNameUpperCamel}> detail(@ApiParam(value = "主键ID") @RequestParam Long id) {
